...
class Constants {
  ...
  static const IS_PRODUCTION = bool.fromEnvironment('dart.vm.product', defaultValue: false);
  ...
  static String SERVER_URL = "http://sisterly-dev-env.eu-central-1.elasticbeanstalk.com";
  static String get APPLE_REDIRECT_URL => SERVER_URL + "/client/oauth/apple/callback";
